...
public class Plugin : BasePlugin
{
    ...
    // ///
    // /// .nameofyourmod-example "some quoted string" 1 1.5
    // /// .nameofyourmod-example boop 21232
    // /// .nameofyourmod-example boop-boop
    // ///</remarks>
    // [Command("nameofyourmod-example", description: "Example command from nameofyourmod", adminOnly: true)]
